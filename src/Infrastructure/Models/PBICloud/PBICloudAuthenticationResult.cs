namespace Sqlbi.Bravo.Infrastructure.Models.PBICloud
{
    ...
    internal sealed class PBICloudAuthenticationResult : IAuthenticationResult, IEquatable<PBICloudAuthenticationResult?>
    {
        private readonly AuthenticationResult _authenticationResult;

        //public DateTimeOffset ExpiresOn => msalResult.ExpiresOn;
