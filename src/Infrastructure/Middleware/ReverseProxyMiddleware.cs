namespace Sqlbi.Bravo.Infrastructure.Middleware
{
    ...
    internal class ReverseProxyMiddleware
    {
        ...
        public ReverseProxyMiddleware(RequestDelegate next, HttpClient httpClient)
        {
            _next = next;
        ...
        {
            //System.Diagnostics.Debug.WriteLine($"::DEBUG >> { context.Request.Path } | { context.Request.QueryString }");
