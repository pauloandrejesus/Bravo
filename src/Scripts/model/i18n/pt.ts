...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.backupReminder]: "Antes de prosseguir, não se esqueça de fazer uma cópia de segurança do seu relatório - <b>algumas alterações poderão não ser reversíveis</b>.",
        ...
        [_.connectDialogOpenVPXMenu]: "Arquivos VPAX",
        [_.connectDialogTitle]: "Aberto",
        [_.connectDragFile]: "Arraste um arquivo VPAX para aqui<br>ou procure no seu computador",
        ...
        [_.daxFormatterFormat]: "Formatar Seleção",
        ...
        [_.devCreateTemplateDialogOk]: "Crio",
        [_.devCreateTemplateLabelModel]: "Baseado em",
        [_.devCreateTemplateLabelName]: "Nome do modelo",
        [_.devCreateTemplateNotes]: "Clique em <strong>Criar</strong> para escolher a pasta onde salvar o projeto de Visual Studio Code que contém o novo modelo.",
        [_.devCreateTemplateTitle]: "Novo modelo de data",
        [_.devDefaultTemplateName]: "Sem título",
        [_.devShowInFolder]: "Mostrar no Explorador de Arquivos",
        ...
        [_.devTemplatesColType]: "Modelo",
        [_.devTemplatesCreate]: "Novo modelo",
        [_.devTemplatesEdit]: "Editar",
        [_.devTemplatesEditTitle]: "Editar no Visual Studio Code",
        [_.devTemplatesEmpty]: "Nenhum modelo de data personalizado encontrado.",
        [_.devTemplatesNotAvailable]: "Este modelo não está mais disponível.",
        [_.devTemplatesRemove]: "Remover",
        [_.devTemplatesTypeOrganization]: "Organização",
        [_.devTemplatesTypeUser]: "Do utilizador",
        [_.devTemplatesVSCodeDownload]: "Baixe o Visual Studio Code",
        [_.devTemplatesVSCodeExtensionDownload]: "Download {extension}",
        [_.devTemplatesVSCodeMessage]: "<p> O projeto do modelo de data agora será aberto com o Visual Studio Code e requer a extensão <b>{extension}</b> a ser compilada. </p> <p> Se ainda não estiver disponível no seu sistema, use o link abaixo para baixar e instalá-los: </p> ",
        [_.devTemplatesVSCodeTitle]: "Aberto com o Visual Studio Code",
        [_.dialogCancel]: "Cancelar",
        [_.dialogContinue]: "Continuar",
        [_.dialogNeverShowAgain]: "Não mostre isso de novo",
        [_.dialogOK]: "OK",
        [_.dialogOpen]: "Abrir",
        [_.docLimited]: "Limitado",
        [_.docLimitedTooltip]: "Nem todas as funcionalidades estão disponíveis para este documento.",
        [_.documentation]: "Documentação",
        [_.doneCtrlTitle]: "Concluído",
        [_.emailAddress]: "Endereço de Email",
        [_.emailAddressPlaceholder]: "Introduza o seu endereço de e-mail",
        [_.error]: "Erro",
        ...
        [_.errorUserSettingsSaveError]: "Não foi possível guardar as definições.",
        [_.errorVpaxFileExportError]: "Ocorreu um erro durante a exportação do arquivo VPAX.",
        [_.errorVpaxFileImportError]: "Ocorreu um erro durante a importação do arquivo VPAX.",
        ...
        [_.exportDataExcelCreateExportSummaryDesc]: "Adicione uma página ao arquivo exportado, com o sumário da tarefa.",
        ...
        [_.exportDataOpenFile]: "Abrir Arquivo Exportado",
        ...
        [_.exportDataTruncated]: "Esta tabela tem muitas linhas. Excel. Use Somente os primeiros milhões de linhas podem ser exportadas para o Excel. Use o formato CSV para exportar todas as linhas da tabela.",
        [_.exportDataTypeCSV]: "CSV (valores separados por vírgulas)",
        [_.exportDataTypeXLSX]: "Planilha do Excel",
        [_.failed]: "Falhou",
        ...
        [_.formattingMeasures]: "Formatando medidas...",
        ...
        [_.helpOptions]: "Opções",
        [_.helpUserInterface]: "Interface de usuário",
        [_.helpTemplates]: "Modelos de datas",
        [_.hideUnsupportedCtrlTitle]: "Apenas suportados",
        [_.less]: "Menos",
        [_.license]: "Publicado sob a licença MIT.",
        [_.loading]: "Carregando...",
        ...
        [_.manageDatesAutoScanSelectedTablesColumns]: "Escolher Colunas...",
        ...
        [_.manageDatesCalendarTemplateName]: "Modelo",
        [_.manageDatesCalendarTemplateNameDesc]: "Selecione <em>Mensal</em> para selecionar o primeiro mês do ano. Escolha <em>Semanal</em> para definir entre os tipos ISO de calendário 445-454-544. Escolha <em>Customizado</em> para calendários flexíveis, de extensão variável.",
        ...
        [_.manageDatesManageTemplates]: "Gerenciar modelos",
        ...
        [_.manageDatesTemplateFirstDayOfWeekDesc]: "Para sistema semanal ISO, defina <em>segunda-feira</em>.",
        ...
        [_.manageDatesTemplateNameConfig02]: "Padrão - Fiscal",
        [_.manageDatesTemplateNameConfig03]: "Mensal",
        [_.manageDatesTemplateNameConfig04]: "Mensal - Fiscal",
        [_.manageDatesTemplateNameConfig05]: "Customizado",
        [_.manageDatesTemplateNameConfig06]: "Customizado - Fiscal",
        [_.manageDatesTemplateNameConfig07]: "Semanal",
        [_.manageDatesTemplateNameCurrent]: "Atual",
        [_.manageDatesTemplateQuarterWeekType]: "Sistema Semanal",
        [_.manageDatesTemplateQuarterWeekTypeDesc]: "",
        [_.manageDatesTemplateTypeStartFiscalYear]: "Data definindo o ano fiscal",
        ...
        [_.optionDev]: "Ativar modelos de data do usuário",
        [_.optionDevDescription]: "",
        [_.optionDiagnostic]: "Nível de Diagnósticos",
        [_.optionDiagnosticDescription]: "Mostra erros e registos num painel de diagnóstico. Escolha <em>Básico</em> para registar apenas algumas mensagens. <em>Detalhado</em> para registar todas as mensagens.",
        [_.optionDiagnosticLevelBasic]: "Básico",
        [_.optionDiagnosticLevelNone]: "Nenhum",
        [_.optionDiagnosticLevelVerbose]: "Detalhado",
        ...
        [_.optionFormattingBreaksDescription]: "Escolha como separar nomes e expressões de medidas. Defina <em>Automática</em> para determinar automaticamente o estilo a usar no modelo.",
        ...
        [_.optionFormattingLinesDescription]: "Escolha entre linhas curtas ou longas.",
        ...
        [_.optionFormattingPreviewDescription]: "Enviar medidas automaticamente para o DAX Formatter, para gerar pré-visualizações.",
        ...
        [_.optionInvalidValue]: "Valor inválido",
        ...
        [_.optionPolicyNotice]: "Esta opção é controlada pelo administrador do sistema.",
        [_.optionProxyAddress]: "Endereço do servidor proxy",
        [_.optionProxyAddressDescription]: "Forneça o endereço do seu servidor proxy.",
        [_.optionProxyBypassList]: "Exclua a lista de endereços",
        [_.optionProxyBypassListDescription]: "Use o servidor proxy, exceto para endereços que começam com as entradas inseridas. Use ponto e vírgula (;) para separar entradas.",
        [_.optionProxyBypassOnLocal]: "Ignorar endereços locais",
        [_.optionProxyBypassOnLocalDescription]: "Não use o proxy com endereços locais (intranet).",
        [_.optionProxyConfirmDeleteCredentials]: "Você certamente remove as credenciais personalizadas do sistema?",
        [_.optionProxyCustomCredentials]: "Credenciais personalizadas",
        [_.optionProxyCustomCredentialsDescription]: "Use credenciais personalizadas para autenticar para o servidor proxy. Deixe de fora para usar as credenciais do sistema.",
        [_.optionProxyCustomCredentialsEdit]: "Edite credenciais personalizadas",
        [_.optionProxyType]: "Servidor proxy",
        [_.optionProxyTypeCustom]: "Personalizada",
        [_.optionProxyTypeDescription]: "Escolha um servidor proxy.",
        [_.optionProxyTypeNone]: "Nenhum",
        [_.optionProxyTypeSystem]: "Sistema",
        [_.optionResetAlerts]: "Alertas de restauração",
        [_.optionResetAlertsButton]: "Restaurar",
        [_.optionResetAlertsDescription]: "Restaure todos os alertas escondidos manualmente.",
        [_.optionsDialogAboutMenu]: "Acerca",
        [_.optionsDialogDevMenu]: "Modelos",
        ...
        [_.otherColumnsRowName]: "Colunas menores...",
        [_.paste]: "Colar",
        [_.powerBiObserving]: "A aguardar que o arquivo abra no Power BI Desktop...",
        ...
        [_.quickActionOpenVPXTitle]: "Abrir um arquivo Vertipaq Analyzer",
        ...
        [_.sceneUnsupportedReasonMetadataOnly]: "A base de dados foi gerada a partir de um arquivo VPAX, que inclui apenas metadados.",
        ...
        [_.searchEntityPlaceholder]: "Procurar Tabela/Coluna",
        ...
        [_.wrappingTitle]: "Quebra automática de linhas",
    }
}
